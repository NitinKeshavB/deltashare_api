...
def mock_share_business_logic(mock_share_info):
    ...
    with (
        patch("dbrx_api.routes_share.list_shares_all") as mock_list,
        patch("dbrx_api.routes_share.get_shares") as mock_get,
        patch("dbrx_api.routes_share.create_share_func") as mock_create,
        patch("dbrx_api.routes_share.delete_share") as mock_delete,
        patch("dbrx_api.routes_share.add_data_object_to_share") as mock_add_objects,
        patch("dbrx_api.routes_share.revoke_data_object_from_share") as mock_revoke_objects,
        patch("dbrx_api.routes_share.adding_recipients_to_share") as mock_add_recipients,
        patch("dbrx_api.routes_share.removing_recipients_from_share") as mock_remove_recipients,
    ):
        # Setup return values
...
def mock_recipient_business_logic(mock_recipient_info):
    ...
    with (
        patch("dbrx_api.routes_recipient.list_recipients") as mock_list,
        patch("dbrx_api.routes_recipient.get_recipient_by_name") as mock_get,
        patch("dbrx_api.routes_recipient.create_recipient_for_d2d") as mock_create_d2d,
        patch("dbrx_api.routes_recipient.create_recipient_for_d2o") as mock_create_d2o,
        patch("dbrx_api.routes_recipient.delete_recipient") as mock_delete,
        patch("dbrx_api.routes_recipient.rotate_recipient_token") as mock_rotate,
        patch("dbrx_api.routes_recipient.add_recipient_ip") as mock_add_ip,
        patch("dbrx_api.routes_recipient.revoke_recipient_ip") as mock_revoke_ip,
        patch("dbrx_api.routes_recipient.update_recipient_description") as mock_update_desc,
        patch("dbrx_api.routes_recipient.update_recipient_expiration_time") as mock_update_exp,
    ):
        # Setup return values
